...
from api.utils.utils import build_targets, to_cpu, non_max_suppression
...
class YOLOLayer(nn.Module):
    ...
    def __init__(self, anchors, num_classes, img_dim=416):
        ...
        self.obj_scale = 1 # 1  #https://github.com/marvis/pytorch-yolo3/blob/master/yolo_layer.py
        self.noobj_scale = 100 # 100
        self.metrics = {}
    ...
    def forward(self, x, targets=None, img_dim=None):
        ...
        if targets is None:
            ...
            # print(pred_conf[noobj_mask], tconf[noobj_mask])
